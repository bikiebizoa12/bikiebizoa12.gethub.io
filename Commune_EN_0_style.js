...
var style_Commune_EN_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("Nom_Arro_1") !== null && resolution > 0 && resolution < 2800) {
        labelText = String(feature.get("Nom_Arro_1"));
    }
